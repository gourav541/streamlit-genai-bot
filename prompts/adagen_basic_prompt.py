...
adagen_basics_system_prompt = """
    ...
    - Always check IF the query of the user seems incomplete then ask user for more clarifications.
    - If user greet you then greet him back and explain them about explain about Dhruv and Adagen Consultancy Services.
